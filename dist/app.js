...
app.use("/branches", branchRouter_1.default);
app.use("/image", imageRouter_1.default);
app.use("/cartItems", cartItemRouter_1.default);
app.use("/providers", providerProfileRouter_1.default);
app.use("/productReviews", productReviewRouter_1.default);
app.use("/badges", badgeRouter_1.default);
app.use("/configurations", globalConfigurationRouter_1.default);
